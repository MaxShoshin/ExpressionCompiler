...
{
    public sealed class ExpressionCopierTests
    {
        [Theory]
        ...
        public void Should_Copy_Method(string methodName)
        {
            ...
            var methodDefinition = module.Types
                .Single(type => type.Name == nameof(ExpressionCopierTests))
        ...
        {
            return typeof(ExpressionCopierTests).GetMethods(BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly)
